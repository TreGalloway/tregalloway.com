        ...
        <div className="mx-auto max-w-2xl">
          {previousPathname && (
            <button
              ...
              className="group mb-8 flex h-10 w-10 items-center justify-center rounded-full bg-card shadow-md shadow-foreground/5 ring-1 ring-border transition hover:ring-border/80 lg:absolute lg:-left-5 lg:-mt-2 lg:mb-0 xl:-top-1.5 xl:left-0 xl:mt-0"
            >
