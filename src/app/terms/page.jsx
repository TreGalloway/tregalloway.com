    ...
    <div className="bg-transparent">
      ...
      <div className="text-left">
        <p className="text-sm text-gray-600">
          We are <strong>TDG LLC</strong> ("Company," "we," "us," "our").
        </p>
        <p className="text-sm text-gray-600">
          We operate the website{' '}
          <a
            href="http://www.tregalloway.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-600"
          >
            http://www.tregalloway.com
          </a>{' '}
          ("Site"), as well as any other related products and services that
          refer or link to these legal terms ("Legal Terms") (collectively, the
          "Services").
        </p>
        <p className="text-sm text-gray-600">
          You can contact us by email at <strong>tre@tregalloway.com</strong> or
          by mail to __________, __________, __________.
        </p>
        <p className="text-sm text-gray-600">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and TDG
          LLC, concerning your access to and use of the Services.
        </p>
        <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="services">
        1. OUR SERVICES
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="ip">
      ...
      <h3 className="text-lg font-bold text-black">Your use of our Services</h3>
      <p className="text-sm text-gray-600">
        Subject to your compliance with these Legal Terms, including the{' '}
        <a href="#prohibited" className="text-blue-600">
      ...
      <ul className="ml-5 list-disc">
        <li className="text-sm text-gray-600">access the Services; and</li>
      ...
      <p className="text-sm text-gray-600">
        ...
        address your request to: <strong>tre@tregalloway.com</strong>.
      </p>

      <h2 className="mt-5 text-xl font-bold text-black" id="products">
        4. PRODUCTS
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="purchases">
      ...
      <ul className="ml-5 list-disc">
        <li className="text-sm text-gray-600">Visa</li>
        <li className="text-sm text-gray-600">Mastercard</li>
        <li className="text-sm text-gray-600">American Express</li>
        <li className="text-sm text-gray-600">Discover</li>
        <li className="text-sm text-gray-600">PayPal</li>
      </ul>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="subscriptions">
        6. SUBSCRIPTIONS
      </h2>
      <h3 className="text-lg font-bold text-black">Billing and Renewal</h3>
      <p className="text-sm text-gray-600">
      ...
      <p className="text-sm text-gray-600">
        We offer a <strong>14</strong>-day free trial to new users who register
        with the Services. The account will be charged according to the user's
        chosen subscription at the end of the free trial.
      </p>

      <h3 className="text-lg font-bold text-black">Cancellation</h3>
      <p className="text-sm text-gray-600">
        ...
        Services, please email us at <strong>tre@tregalloway.com</strong>.
      </p>

      <h3 className="text-lg font-bold text-black">Fee Changes</h3>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="returnno">
        7. REFUNDS POLICY
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="software">
        8. SOFTWARE
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="prohibited">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="ugc">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="license">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="reviews">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="thirdparty">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="sitemanage">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="ppyes">
        15. PRIVACY POLICY
      </h2>
      <p className="text-sm text-gray-600">
        ...
        <strong>
          <a
            href="http://www.tregalloway.com/privacy"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-600"
          >
            http://www.tregalloway.com/privacy
          </a>
        </strong>
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="california">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="misc">
        28. MISCELLANEOUS
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <h2 className="mt-5 text-xl font-bold text-black" id="contact">
        29. CONTACT US
      </h2>
      <p className="text-sm text-gray-600">
      ...
      <p className="text-sm text-gray-600">
        <strong>TDG LLC</strong>
      </p>
      <p className="text-sm text-gray-600">
        <strong>tre@tregalloway.com</strong>
      </p>
    </div>
  )
}
